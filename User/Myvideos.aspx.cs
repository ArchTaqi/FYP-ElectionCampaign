...
public partial class User_Myvideos : System.Web.UI.Page
{
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection Sqlcon = new SqlConnection(strCon))
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "uspGetuservideos";
    ...
    {
        int videoid = Convert.ToInt32(gvvideos.SelectedRow.Cells[1].Text);
        Response.Redirect("../User/Videodetails.aspx?ID=" + videoid);
    }
