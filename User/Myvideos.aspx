<%@ Page Title="" Language="C#" MasterPageFile="~/User/Users.master" AutoEventWireup="true" CodeFile="Myvideos.aspx.cs" Inherits="User_Myvideos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width: 99.8%; height: 700px; border: 1px ridge black; text-align: center; vertical-align: middle;">
        ...
        <div style="width: 100%; height: 30px; line-height: 30px; font-family: Calibri; font-size: x-large; font-weight: lighter; font-style: normal; font-variant: small-caps; text-transform: uppercase; color: #FFFFFF; text-decoration: none; background-color: #000000;">
            <asp:Label ID="Label11" runat="server" Text="My Videos"></asp:Label>
        </div>

        <%--1st Panel--%>
        <div style="width: 100%; height: 80px; margin: 0 auto; margin-top: 10px;">
            <div style="width: 100%; height: 40px; text-align: center">
                <asp:Label ID="Label2" runat="server" Text="Select the consittuecy to see the videos against that consitutency" ForeColor="Black" Font-Names="Calibri" Font-Size="Medium"></asp:Label>
        ...
        <div style="width: 100%; height: 500px; float: left; margin-top: 50px;">
            <%-- Div Heading--%>
            <div style="width: 100%; height: 30px; line-height: 30px; font-family: Calibri; font-size: x-large; font-weight: lighter; font-style: normal; font-variant: small-caps; text-transform: uppercase; color: #FFFFFF; text-decoration: none; background-color: #000000;">
                <asp:Label ID="Label3" runat="server" Text="Videos List"></asp:Label>
            </div>
            <asp:GridView ID="gvvideos" runat="server" Font-Names="Calibri" Font-Size="Small" AllowPaging="True" AllowSorting="True" HorizontalAlign="Justify" PageSize="15" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="gvevents_SelectedIndexChanged" SelectedRowStyle-Height="30px">
                <Columns>
